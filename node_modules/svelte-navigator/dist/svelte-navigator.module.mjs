import { SvelteComponent, init, safe_not_equal, assign, create_slot, element, space, empty, set_attributes, insert, get_spread_update, update_slot_base, get_all_dirty_from_scope, get_slot_changes, transition_in, transition_out, detach, component_subscribe, text, append, set_data, group_outros, check_outros, compute_rest_props, exclude_internal_props, create_component, mount_component, destroy_component, get_spread_object, listen } from 'svelte/internal';
...
const get_default_slot_context = ctx => ({
	params: isSSR ? get(/*params*/ ctx[10]) : /*$params*/ ctx[4],
...
function create_if_block_1(ctx) {
	...
	const switch_instance_spread_levels = [
		{ location: /*$location*/ ctx[3] },
		{ navigate: /*navigate*/ ctx[11] },
		isSSR ? get(/*params*/ ctx[10]) : /*$params*/ ctx[4],
		/*$$restProps*/ ctx[12]
	];
	...
	return {
		...
		p(ctx, dirty) {
			...
			? get_spread_update(switch_instance_spread_levels, [
					...
					dirty & /*isSSR, get, params, $params*/ 1040 && get_spread_object(isSSR ? get(/*params*/ ctx[10]) : /*$params*/ ctx[4]),
...
/* src\Link.svelte generated by Svelte v3.49.0 */
...
export { Link$1 as Link, Route$1 as Route, Router$1 as Router, createHistory, createMemorySource, globalHistory, link, links, navigate, useFocus, useLocation, useMatch, useNavigate, useParams, useResolvable, useResolve };
