...
export type { EditArticleMetadata } from './models/EditArticleMetadata';
...
export type { FullProteinInfo } from './models/FullProteinInfo';
...
export type { ProteinBody } from './models/ProteinBody';
...
export type { RequestBodyEdit } from './models/RequestBodyEdit';
